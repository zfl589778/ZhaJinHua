...
public class RegUtil {
	 ...
	 * 匹配 : /forum/head_icon/aaa.gif 或 aaa.dmp
	 * 不匹配: c:/aaa.gif
	 * 
	 */
	 ...
	 * 匹配纯数字 + 空格
	 */
	public static final String NUMBER_REGEXP_AND_SPACE = "^[0-9]+ [0-9]+$";
	
	//国内手机号
	public static final String CHINA_MOBILE_REGEXP = "^[1][34578][0-9]{9}$";
	
	//验证码格式验证
	public static final String MOBILE_VERCODE = "^[0-9]{6}$";
	
	//IP验证
	//public static final String LOCAL_IP_CONN = "^127\\.0\\.0\\.1:\\d+$|^localhost:\\d+$";
	
	public static boolean test(String reg, String org){
